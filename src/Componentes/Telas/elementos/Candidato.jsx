...
export default function Candidato(props) {
    function adicionarCurtida(){
        props.setListaCandidatos(props.listaCandidatos.filter((candidato)=>{
            if(props.candidato.id === candidato.id)
                candidato.curtidas++;
            return candidato
        }))
    }
        ...
        <Card style={{ width: '18rem' }}>
            ...
            <Card.Body>
                ...
                <Button className="mt-1" variant="success" onClick={()=>{
                    props.setIdSelecionado(props.candidato.id);
